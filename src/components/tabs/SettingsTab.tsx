          ...
          <form ref={settingsFormRef} onSubmit={handleSaveSettings} className="space-y-6" onChange={() => setHasUnsavedChanges(true)}>
            ...
            <div className="space-y-4 pt-4 border-t">
              ...
              <div className="space-y-2">
                ...
                <Input id="taxRate" name="taxRate" type="number" step="0.1" defaultValue={settings.taxRate} aria-describedby="taxRateHelper" />
                <p id="taxRateHelper" className="text-xs text-muted-foreground">Пример: 6 для УСН 6%</p>
              </div>
            </div>
