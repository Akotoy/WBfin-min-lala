      ...
      <Card className="border-none shadow-sm">
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <div className="flex gap-2">
            <Input placeholder="Поиск по артикулу..." className="w-64" aria-label="Поиск по артикулу" />
          </div>
        </CardHeader>
        <CardContent>
          <Table>
                ...
                <TableRow key={product.nmId}>
                  ...
                  <TableCell>
                    <Input
                      ...
                      placeholder="0"
                      aria-label={`Себестоимость товара ${product.title}`}
                    />
                  </TableCell>
                  <TableCell>
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => handleUpdatePrice(product.nmId, product.price + 100)}
                      aria-label={`Увеличить цену товара ${product.title} на 100 рублей`}
                    >
                      +100 ₽
                    </Button>
                  </TableCell>
